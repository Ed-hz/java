 ...
 */
public class LoggingImageViewerfx extends Application
{
   ...
   public void start(Stage stage) throws IOException
   {
      ...
      logger.addHandler(new TalkingClock_1(stage, Level.ALL));
 ...
 */
class TalkingClock_1 extends StreamHandler
{
   public TalkingClock_1(Stage parent, Level level)
   {
      setLevel(level);
